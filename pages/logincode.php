...
class Login
{
    ...
    private function showPageLoggedIn()
    {
        ...
        echo '<p>Hello ' . $_SESSION['user_name'] . ', you are logged in.<br/><br/>';
    ...
    private function showPageLoginForm()
    {
        ...
        echo '<p><label for="login_input_username">Username</label> ';
    ...
    private function showPageRegistration()
    {
        ...
        echo '<p><b>Registration:</b></p>';

        echo '<form method="post" action="' . $_SERVER['SCRIPT_NAME'] . '?action=register" name="registerform">';
        echo '<label for="login_input_username"><p>Username (only letters and numbers, 2 to 64 characters)</p></label>';
        echo '<input id="login_input_username" type="text" pattern="[a-zA-Z0-9]{2,64}" name="user_name" required />';
        echo '<label for="login_input_email"><p>User\'s email</p></label>';
        echo '<input id="login_input_email" type="email" name="user_email" required />';
        echo '<label for="login_input_password_new"><p>Password (min. 6 characters)</p></label>';
        ...
        echo '<label for="login_input_password_repeat"><p>Repeat password</p></label>';
